...
function DevForm({ onSubmit }) {
    ...
    useEffect(() => {
        //Dispara uma função 
        //toda vez que uma variavel
        //dentro do vetor alterar
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="input-group">
                ...
                <div className="input-block">
                    ...
                    <input type="Number" name="logitude" id="logitude" value={longitude} onChange={e => setLongitude(e.target.value)} required />
                </div>
